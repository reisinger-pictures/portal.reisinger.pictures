...
class User extends Authenticatable implements JWTSubject
{
    ...
    /** @var array<string, array{gallery_ids: array<int, string>, meta_gallery_ids: array<int, string>}> */
    public $transient_invites = [];

    /** @var array<int, string> */
    public $transient_invite_ids = [];
    ...
    public function orders()
    {
        ...
        // A transient guest has no users row to anchor a HasMany relation;
        // never let this convenience relation recreate user_id IS NULL.
        if ($this->getKey() === null) {
            $relation->getQuery()->whereRaw('1 = 0');
        } else {
            $relation->getQuery()->whereNull('guest_id');
        }
